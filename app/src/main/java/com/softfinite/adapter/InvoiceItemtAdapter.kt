...
import kotlinx.android.synthetic.main.item_order_invoice.view.*

/**
 * Created by Softfinite (Viv'Ek Chodvadiya) on 13-Jun-18.
 */

class InvoiceItemtAdapter(internal var context: Context) : RecyclerView.Adapter<InvoiceItemtAdapter.MyViewHolder>() {
...
//
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        ...
        val v = inflater.inflate(R.layout.item_order_invoice, parent, false)
