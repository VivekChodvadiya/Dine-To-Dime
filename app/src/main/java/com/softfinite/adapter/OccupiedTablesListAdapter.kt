...
import kotlinx.android.synthetic.main.item_occupied_table.view.*

/**
 * Created by Softfinite (Viv'Ek Chodvadiya) on 13-Jun-18.
 */

class OccupiedTablesListAdapter(internal var context: Context) : RecyclerView.Adapter<OccupiedTablesListAdapter.MyViewHolder>() {

    private var data: MutableList<Dummy>? = ArrayList<Dummy>()

    internal var imageLoader: ImageLoader
    internal var myEventAdapter: OccupiedTablesListAdapter? = null
...
//
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        ...
        val v = inflater.inflate(R.layout.item_occupied_table, parent, false)
