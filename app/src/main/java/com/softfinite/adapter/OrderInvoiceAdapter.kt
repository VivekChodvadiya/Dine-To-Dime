...
class OrderInvoiceAdapter(internal var context: Context) : RecyclerView.Adapter<OrderInvoiceAdapter.MyViewHolder>() {

    private var data: MutableList<Dummy>? = ArrayList<Dummy>()

    internal var imageLoader: ImageLoader
    internal var myEventAdapter: OrderInvoiceAdapter? = null
