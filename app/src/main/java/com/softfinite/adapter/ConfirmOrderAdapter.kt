...
class ConfirmOrderAdapter(internal var context: Context) : RecyclerView.Adapter<ConfirmOrderAdapter.MyViewHolder>() {

    private var data: MutableList<Dummy>? = ArrayList<Dummy>()

    internal var imageLoader: ImageLoader
    internal var myEventAdapter: ConfirmOrderAdapter? = null
...
//
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        ...
        val v = inflater.inflate(R.layout.item_confirm, parent, false)
