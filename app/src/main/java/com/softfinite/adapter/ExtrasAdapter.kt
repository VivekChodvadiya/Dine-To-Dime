...
class ExtrasAdapter(internal var context: Context) : RecyclerView.Adapter<ExtrasAdapter.MyViewHolder>() {

    private var data: MutableList<Dummy>? = ArrayList<Dummy>()

    internal var imageLoader: ImageLoader
    internal var myEventAdapter: ExtrasAdapter? = null
...
//
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        ...
        val v = inflater.inflate(R.layout.item_extras, parent, false)
