...
import kotlinx.android.synthetic.main.item_cart_served.view.*

/**
 * Created by Softfinite (Viv'Ek Chodvadiya) on 13-Jun-18.
 */

class CartServedAdapter(internal var context: Context) : RecyclerView.Adapter<CartServedAdapter.MyViewHolder>() {
...
//
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        ...
        val v = inflater.inflate(R.layout.item_cart_served, parent, false)
