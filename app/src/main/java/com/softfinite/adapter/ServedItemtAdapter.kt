...
import kotlinx.android.synthetic.main.item_served.view.*

/**
 * Created by Softfinite (Viv'Ek Chodvadiya) on 13-Jun-18.
 */

class ServedItemtAdapter(internal var context: Context) : RecyclerView.Adapter<ServedItemtAdapter.MyViewHolder>() {
...
//
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        ...
        val v = inflater.inflate(R.layout.item_served, parent, false)
