...
class SelectMoreCombosAdapter(internal var context: Context) : RecyclerView.Adapter<SelectMoreCombosAdapter.MyViewHolder>() {

    private var data: MutableList<Dummy>? = ArrayList<Dummy>()

    internal var imageLoader: ImageLoader
    internal var myEventAdapter: SelectMoreCombosAdapter? = null
...
//
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        ...
        val v = inflater.inflate(R.layout.item_select_more_combos, parent, false)
