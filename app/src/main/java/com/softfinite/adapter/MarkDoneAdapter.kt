...
class MarkDoneAdapter(internal var context: Context) : RecyclerView.Adapter<MarkDoneAdapter.MyViewHolder>() {

    private var data: MutableList<Dummy>? = ArrayList<Dummy>()

    internal var imageLoader: ImageLoader
    internal var myEventAdapter: MarkDoneAdapter? = null
...
//
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        ...
        val v = inflater.inflate(R.layout.item_mark_done, parent, false)
