...
class MenuTablesListAdapter(internal var context: Context) : RecyclerView.Adapter<MenuTablesListAdapter.MyViewHolder>() {

    private var data: MutableList<Dummy>? = ArrayList<Dummy>()

    internal var imageLoader: ImageLoader
    internal var myEventAdapter: MenuTablesListAdapter? = null
...
//
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        ...
        val v = inflater.inflate(R.layout.item_menu_table_list, parent, false)
