...
class SideMenusAdapter(internal var context: Context) : RecyclerView.Adapter<SideMenusAdapter.MyViewHolder>() {

    private var data: MutableList<Dummy>? = ArrayList<Dummy>()

    internal var imageLoader: ImageLoader
    internal var myEventAdapter: SideMenusAdapter? = null
...
//
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        ...
        val v = inflater.inflate(R.layout.item_side_menu, parent, false)
...
////
        ...
        holder.imgDownArrow.setImageDrawable(item.drawable)
...
//        return 25;
    ...
    class MyViewHolder(v: View) : RecyclerView.ViewHolder(v) {
        ...
        val imgDownArrow = v.imgDownArrow
        val tvMenuName = v.tvMenuName
    }
}
